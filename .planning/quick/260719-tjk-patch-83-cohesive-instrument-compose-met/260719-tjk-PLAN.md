...
two unrelated affordances. The new segmented-well design (per user's 2026-07-19 design
...
<task type="checkpoint:human-verify" gate="blocking">
  <name>Task 2: user browser eyeball — cohesive instrument + drain animation</name>
  <what-built>
...
- user browser eyeball (Task 2 checkpoint) — cohesive instrument reads correctly, drain animation runs, reset dispatch fires, null-contextPct case handled.
</verification>

<success_criteria>
- Single-file patch to ComposeBox.tsx committed to `feat/tab-title-from-tmux` after user's approval.
- tsc + vite build pass.
...
- Deploy is a SEPARATE step user controls (per tina.md deploy discipline) — this task stops at commit.
</success_criteria>

<output>
Create `.planning/quick/260719-tjk-patch-83-cohesive-instrument-compose-met/260719-tjk-SUMMARY.md` when user approves the checkpoint and the commit lands.
</output>
