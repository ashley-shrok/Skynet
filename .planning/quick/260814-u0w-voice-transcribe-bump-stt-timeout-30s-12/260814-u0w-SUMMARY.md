...
**One-liner:** Bumped handleTranscribe AbortController from 30s to 120s and added a fire-and-forget disk-bank of incoming audio buffers (user 2026-08-14 3.87 MB lost-dictation incident fix).
...
- Comment updated from "30-second STT timeout" to "120-second STT timeout" with citation of the user 2026-08-14 3.87 MB clip incident
