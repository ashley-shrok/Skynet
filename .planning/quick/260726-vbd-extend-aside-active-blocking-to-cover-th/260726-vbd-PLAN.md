...
Purpose: Prevents user from sending unrelated input into the terminal
...
<task type="auto" tdd="false">
  ...
  <action>
    ...
    claude-session-server.ts — separate followup pending user's
    cooldown UAT.
  </action>
  <verify>
