...
<verification>
Manual smoke (visual verification is out of scope for this autonomous quick task — orchestrator/user can visually verify after commit):
