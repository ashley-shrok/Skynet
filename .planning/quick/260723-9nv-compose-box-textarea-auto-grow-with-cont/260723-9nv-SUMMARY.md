...
- Working tree clean (except intentional `.planning/quick/260723-9nv-.../` untracked, per fork convention — quick planning docs stay untracked until user or tina decides to snapshot them).
