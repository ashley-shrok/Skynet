...
This prevents the stuck "Waking up…" overlay when user returns to a pane whose WS was closed by patch #344 during hidden-time and whose session has since re-dormanted.
