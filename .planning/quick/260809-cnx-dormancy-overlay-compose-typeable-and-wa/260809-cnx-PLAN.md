...
autonomous: true
requirements:
  - CNX-A  # ComposeBox mounts in reduced state during dormant so user can pre-draft
  ...
  <action>
    ...
    describe("quick 260809-cnx dormant flow refinements", () => {
      ...
      it("Fix B: visibility false→true transition resets stale waking state", () => {
        ...
        // Hide the pane (simulates user navigating away — patch #344 closes WS).
