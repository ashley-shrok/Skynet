...
The `skynet-patches.md` header bump (97 → 98) and per-patch entry belong to PIN time — do NOT edit skynet-patches.md here (per brief constraint and Alice's pin-time-only rule for `/home/ubuntu/.claude/identities/tina/skynet-patches.md`).
