...
key-files:
  ...
  modified:
    ...
    - src/ui/index.css
decisions:
  - "Attribute selector `[data-pv-conv-wip-dot='true']` instead of a class name for the reduced-motion fallback — avoids coupling to a class user hasn't sanctioned, keeps the render slot self-contained."
