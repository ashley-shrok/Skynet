...
Purpose: A row whose pretty-view surface is showing the "session recycling..." overlay is NOT ready for user's next instruction; showing the ready-dot on such a row is a false-positive signal. Correct that.
