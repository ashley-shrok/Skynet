...
Fix the double-bubble bug user hit in her tina session on 2026-08-23 when she
...
CC input transformation (JSON paste normalization user also reported, XML
...
quick-260823-fzy rationale + user's `/fake` corpus (path + timestamp).
