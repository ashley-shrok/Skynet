...
**One-liner:** Three coordinated fixes — type-aware height estimates, aspect-ratio image reservation, and overflow-anchor suppression — reduce TanStack Virtual re-measure displacement under user's scroll gesture.
