...
description: Rip the vestigial Send button + dead sendDisabled derived state out of ComposeBox — Enter (via patch #118) is the sole submit path user uses.
created: 2026-07-22
status: planned
---
