...
**NOT pushed. NOT built. NOT deployed.** Per fleet rule "code work doesn't authorize ship." user's ship queue is held pending more changes; this becomes commit 6 (through 9) in the batch atop origin `67c49dd`, waiting on explicit "ship it."
