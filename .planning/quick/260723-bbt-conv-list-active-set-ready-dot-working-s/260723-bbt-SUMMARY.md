...
dependency-graph:
  ...
  affects:
    ...
    - Rows where the agent is idle (isIdle-published false) AND that user has engaged with show a steady hue-cream "ready" dot
tech-stack:
  added:
