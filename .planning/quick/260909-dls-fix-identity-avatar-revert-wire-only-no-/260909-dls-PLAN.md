...
- Push-only ship: no docker build, no docker cp, no --force-recreate, no deploy this session. Push happens at the campaign ship gate per user 2026-09-07, batched with the other 7 completed bounties.
</success_criteria>
