...
Per box-maintainer fleet rule (user 2026-08-08): sub-agents do not deploy. No `git push`, no `docker build`, no `docker compose`, no coord-room posts, no `skynet-patches.md` entries.
