...
and Wi-Fi flap mid-typing. user routinely composes long multi-line
...
PIN (post-deploy, after user confirms the deploy holds), not at
commit — user's deploy step is still pending and separate from
this commit.
