...
user 2026-08-05: fleet-shape rarely changes, no reason for a page refresh to paint an empty list for the ~200ms until the fetch lands.
...
- Commit + push + build + recreate inline (session pattern — user 2026-08-05).
