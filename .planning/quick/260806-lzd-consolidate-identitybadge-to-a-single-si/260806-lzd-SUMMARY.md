...
key-files:
  ...
  modified:
    ...
    - src/ui/features/pretty-view/PrettyView.tsx
decisions:
  - "Long-press timer = 500ms setTimeout (per user's plan brief). Any pointermove while armed cancels — deliberate press only, no hover-slide."
