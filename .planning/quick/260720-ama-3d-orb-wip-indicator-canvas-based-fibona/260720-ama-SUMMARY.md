...
decisions:
  - "Algorithm parameters (N=150, 0.55/0.31 rad/s, 0.88 radius, dot-size and alpha formulas, rgba(150,180,220)) locked by user 2026-07-20 — not re-derived"
...
Deferred to deploy time in user's browser (per plan spec). The design was locked after 4 rounds of prototyping — design archive at `~/.claude/identities/tina/bounties/spirograph-wip-indicator/NOTES.md`.
