...
## user's Ask (2026-08-03 verbatim)
...
**HELD pending user greenlight.** Fleet directive: code motion only —
no push, no `docker build`, no `docker compose up`. user greenlights ship
separately.
