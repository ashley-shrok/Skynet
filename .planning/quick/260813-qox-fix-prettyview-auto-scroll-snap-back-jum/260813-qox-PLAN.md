...
<objective>
Fix the PrettyView auto-scroll snap-back / jump on tall-bubble re-measure (user report
...
the RO yanks scroll on the next re-measure. Structural fix (user greenlit over a threshold
