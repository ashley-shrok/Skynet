...
STEP 4 — Commit as a single atomic commit. Do NOT push (user's fleet rule: full-suite green is a precondition for PUSH not COMMIT; orchestrator batches this ship with patch #521 + #522 and runs full-suite at ship time). Commit message via HEREDOC:
