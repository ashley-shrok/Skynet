...
The batch (patches #118 through #125) sits behind the mandatory 15-min deadman-rollback window per fork DEPLOY DISCIPLINE. user-gated release.
...
Six-work-stream PWA install polish for the user-iPhone Add-to-Home-Screen moment:
