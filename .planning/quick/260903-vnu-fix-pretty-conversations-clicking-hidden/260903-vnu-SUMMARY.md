...
Inverts `quick-260731-tgg` per user 2026-09-03 directive. Two lines were deleted from `handleRowSelect` in `PrettyConversationsPanel.tsx`:
...
- `grep "user 2026-09-03" PrettyConversationsPanel.tsx` → 1 match inside `handleRowSelect`
