...
- **Scope edge (IN): add a new file to the currently-open skill** — present · "+ Add file" + prompt + create endpoint; user endorsed sub-path creation as intended.
