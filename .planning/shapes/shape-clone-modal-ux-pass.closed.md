...
- Bounty parked 2026-09-07 from user's UX-pass digest as a small
...
- user confirmed 2026-09-08: the row context menu is the only
...
- Renaming the context-menu item to something more descriptive
  than "create new agent under this role." user greenlit that
  specific text.
...
user 2026-09-07 verbatim):** push + scoped tests only per bounty;
...
**Standing rule (user 2026-09-07 verbatim):** *"after each build
...
**user delegated to tabitha (2026-09-07 verbatim):** *"you're in
