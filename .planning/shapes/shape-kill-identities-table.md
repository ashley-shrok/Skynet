...
Bounty at `~/.claude/roles/box-maintainer/bounties/kill-identities-table-phase-68/` holds the original premise user greenlit on 2026-09-01, plus the call-site inventory list from ship-day.
