...
completed bounties per user 2026-09-07. No docker build, no `docker cp`,
...
**Deploy policy:** push-only per campaign discipline. Awaits user's push greenlight; batches with UX-pass campaign ship gate.
