...
- **OUT:** the fleet-substrate-artifacts github repo (task #22 in the feature doc). Vendoring in-tree replaces the need for a separate artifacts repo entirely; task #22 is moot as of user's 2026-09-04 direction.
