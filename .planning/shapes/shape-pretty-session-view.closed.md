...
- **What would make it wrong: Heavy flip** — hit · user confirmed the flip feels free — fast, no state loss, no fight. xterm stays alive via display:none so tmux session persists underneath and flip-back is instant.
