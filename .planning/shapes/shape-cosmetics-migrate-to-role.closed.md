...
- **What would make it wrong — build forces migration on existing identities** — present · No auto-lift, no auto-wipe, no warning prompts; migration stays with whoever deploys per user 2026-09-07
