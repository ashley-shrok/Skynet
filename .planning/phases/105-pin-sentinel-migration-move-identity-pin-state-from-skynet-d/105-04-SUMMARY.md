...
- **UI feel invariant preserved (D-06):** pin toggle from the user's perspective is byte-identical to pre-Phase-92. Same right-click menu entry text, same fire-and-forget optimistic flip, same silent-catch on network failure, same hydrate-on-mount reconciliation. user 2026-09-09 verbatim: "however it feels now is how it's going to feel after this."
