...
- **Note the round-trip semantics**: Skynet is READ-ONLY. Save button in the modal attaches the edit to user's NEXT message; agent decides what to do with it. Skynet never overwrites files.
