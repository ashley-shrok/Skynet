...
**If this table is empty:** Not empty — 7 assumptions listed above. Planner and user should review A4 (birth-orchestrator step numbering) and A5 (credentials.txt permissions) as they touch surfaces adjacent to Phase 77.
