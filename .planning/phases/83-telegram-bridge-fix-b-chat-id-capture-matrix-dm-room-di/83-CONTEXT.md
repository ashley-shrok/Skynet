...
**Urgency:** user currently has ZERO wrist reachability. Nina's bridge was taken down 2026-09-07 in preparation for cutover; the new tg-bridge container is up but cannot route MX↔TG without chat_id capture + room discovery. Pre-authorized by user — she said verbatim: *"pick up with progressing to the real finish line in all of this when next session starts."*
