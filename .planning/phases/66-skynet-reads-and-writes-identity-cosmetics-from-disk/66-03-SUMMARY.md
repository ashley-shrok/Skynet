...
Between "Plan 03 lands" (right now) and "Plan 05 lands" the frontend renders with safe-default cosmetics on every identity (capitalizeFirst names, no avatars, gray backgrounds). user greenlit this as "accept the ugly render" per shape file open question 4.
