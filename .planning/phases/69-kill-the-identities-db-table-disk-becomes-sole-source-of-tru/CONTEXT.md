...
7. **user pre-authorized** the phase via `/build`. Standing directive from role file: greenlight at push, not at recreate. Ship-gate = full vitest suite green.
