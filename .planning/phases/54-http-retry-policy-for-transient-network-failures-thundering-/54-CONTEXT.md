...
user runs ~10 Skynet Chrome windows on one box. When Chrome crashes (or the OS
...
When user next reports a "can't connect" toast, the console-forward log
...
user closes Chrome (10 Skynet tabs open), hits Restore, and sees ZERO
