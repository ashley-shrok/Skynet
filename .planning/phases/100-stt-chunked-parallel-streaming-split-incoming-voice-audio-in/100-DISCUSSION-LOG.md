...
**Notes:** Tabitha argued from benchmark data — 3 s → 0.8 s and 8 s → 3.6 s on single-stream today; adding chunker overhead to those clips makes UX worse. user concurred.
