...
4. Verify user's original 2026-09-06 bug: Ivy (which recycled overnight) rises above Lulabelle after user sends to Ivy once, regardless of Ivy's transcript state.
...
8. **No backfill** (D-09) — zero backfill logic anywhere; store fills naturally as user sends.
