...
- **Manual sanity check (orchestrator scope, post-deploy):**
  ...
  5. Verify user's original 2026-09-06 bug: Ivy (which recycled overnight) should now rise above Lulabelle after user sends to Ivy once, regardless of Ivy's transcript state.
