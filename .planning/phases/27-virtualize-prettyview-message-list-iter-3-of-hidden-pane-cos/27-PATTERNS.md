...
- **Option B** — render them as siblings but sticky-positioned (`position: sticky; bottom: 0`). Adds visual complexity, changes the ASIDE-05 in-flow-not-overlay contract, likely NOT what user wants.
