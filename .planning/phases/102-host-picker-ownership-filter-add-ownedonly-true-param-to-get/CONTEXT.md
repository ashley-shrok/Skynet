...
Seeded from live conversation with user 2026-09-10 during role-cosmetics-data-migration UAT.
...
## Solution shape (LOCKED — user 2026-09-10)
...
- **Bundled ship with newline fix** (commit `f5b6c4e0`) — user's directive:
