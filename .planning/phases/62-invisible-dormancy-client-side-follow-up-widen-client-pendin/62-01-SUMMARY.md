...
- **Backend watchdog non-arming for dormant sends** — user's log shows the backend `pv_input_arm_split` did NOT fire for hilda's dormant send at 13:46:26 (potentially another Phase 60 gap). CONTEXT.md L82: investigate as follow-up bounty, NOT Phase 62 scope.
