...
dependency_graph:
  ...
  affects:
    ...
    - "Future role-cosmetic-edit modal bounty (deferred per user 2026-09-07) — same inherit/override affordance patterns can be reused for cross-role cosmetic authoring"
tech_stack:
  added: []
  patterns:
