...
- **Verbatim copy** — the sentence text (including the period after "adopt.") is greenlit by user and must land byte-exact.
...
2. Flip label text at L958 from `Create with new identity` → `Just a shell — no agent` (user verbatim greenlit — 88-CONTEXT.md L34-36).
