...
- **The parity-map test caught a real design surface.** Writing the test forced explicit enumeration of every skipped row's reason — matches user's "enumerate first, code second" preference from CONTEXT.md and gives Plan 02 a durable checklist of what NOT to emit.
