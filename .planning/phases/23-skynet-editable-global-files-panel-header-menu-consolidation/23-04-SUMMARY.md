...
Task 2 is a `type="checkpoint:human-verify"` requiring user's live verification post-deploy. It cannot be executed as code. The 11-step UAT checklist from the plan covers:
...
**Resume signal:** user types "approved" after all 11 checks pass.
