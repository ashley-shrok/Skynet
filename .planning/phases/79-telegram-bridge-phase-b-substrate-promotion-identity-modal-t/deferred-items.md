...
Not blocking Plan 03 — errors are IN Plan 04's own files, do not affect this plan's tests or the build gate that user requested (`docker build` will fail if these persist through Wave 3, but that's Plan 04's problem to fix).
