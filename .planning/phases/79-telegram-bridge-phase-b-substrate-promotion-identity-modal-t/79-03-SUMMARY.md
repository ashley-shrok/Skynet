...
- 8 `assertSafeHumanName` accept/reject cases (accepts user/zoey/laura/commander-zoey/agent_007; rejects `../etc/passwd`, `foo bar`, `foo;rm -rf /`, `foo$bar`, empty, 65-char, `-leading-hyphen`, uppercase)
