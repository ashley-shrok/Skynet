...
3. **Bot token input is `type="password"`** — browser autofill won't offer to save it. This is intentional (T-79-07-01) but may surprise user if she expects browser password-manager help. Not a bug.
