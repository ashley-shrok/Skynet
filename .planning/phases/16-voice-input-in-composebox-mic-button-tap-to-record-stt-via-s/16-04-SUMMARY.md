...
tech_stack:
  added: []
  patterns:
    - Inline docs-with-code per user's 2026-07-27 fleet directive
key_files:
  created: []
  modified:
...
- **Motivation**: user's one-hand voice composition need for iOS PWA; prototype UAT-passed 2026-07-27
