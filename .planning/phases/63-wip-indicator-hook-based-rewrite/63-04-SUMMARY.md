...
affects:
  ...
  - Every managed box that has NOT been re-installed continues to drive isWorking via the retained Phase 59 shell-idle-gate predicate — Alice has adapted to the known bugs on unupgraded boxes, adaptation is intact until each box gets the Plan 62-02 installer.
tech-stack:
  added: []
  patterns:
