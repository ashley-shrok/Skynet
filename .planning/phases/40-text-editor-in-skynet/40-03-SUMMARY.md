...
decisions:
  - "Rev-2 (2026-08-14, user explicit greenlight): draft-guard confirm gate INCLUDED in this plan (originally deferred). Modal fires window.confirm('Discard unsaved changes?') on dirty close; save-success bypasses via savingRef"
