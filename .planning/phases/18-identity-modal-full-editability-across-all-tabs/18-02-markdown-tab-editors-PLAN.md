...
IDMEDIT-03. user must be able to open the identity modal on nelly (or
...
2026-07-31 file-editing-in-identity-modal scratch UAT (user
...
<task type="auto" tdd="false">
  ...
  <read_first>
    ...
    - Bounty scratch reference: `/home/ubuntu/.claude/identities/tina/bounties/file-editing-in-identity-modal/` — user greenlit this shape on the docker-cp scratch 2026-07-31. Consult if any shape question arises; do not re-litigate.
  </read_first>
  <action>
...
<task type="checkpoint:human-verify" gate="blocking">
  <name>Task 4: user UAT — markdown-tab edits work both LOCAL and REMOTE</name>
  <what-built>
...
- user UAT Task 4 approved on all 13 steps
