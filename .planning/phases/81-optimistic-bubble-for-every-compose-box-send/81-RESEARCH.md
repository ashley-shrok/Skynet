...
- Compose is NOT repopulated on failure (user 2026-09-02 reversed Phase 50 D-20/D-56). No retry-easier affordance, no staged-file preservation.
...
**Why it happens:** user could paste a message that literally includes the delimiter substring as text.
