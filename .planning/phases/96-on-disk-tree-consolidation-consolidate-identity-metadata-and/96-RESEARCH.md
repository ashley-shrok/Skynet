...
**Audience:** user (t1000), Stacy (T800), any future box maintainer. Plain language, no assumed context, self-contained.
...
6. MIGRATION.md is readable and self-contained — user and Stacy can follow it verbatim.
