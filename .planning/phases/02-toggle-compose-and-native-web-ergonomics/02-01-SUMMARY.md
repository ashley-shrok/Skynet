...
key_files:
  ...
  modified:
    ...
    - src/ui/shell/tabUtils.tsx
decisions:
  - "Chord is Ctrl+Shift+O (e.code === KeyO) per D-32 — layout-independent, unbound in Chrome/VS Code/user's OS"
...
The chord ships as Ctrl+Shift+O per D-32. user's confirmation of non-collision with her live OS bindings happens at Plan 03's deploy checkpoint (browser UAT), not in this plan.
