...
- user 2026-09-06 verbatim intent
- Why `background` shorthand (not `backgroundColor`) is critical for defeating the gradient

## Exact CSS Tuple Shipped (user's End-of-Phase UAT Reference)
