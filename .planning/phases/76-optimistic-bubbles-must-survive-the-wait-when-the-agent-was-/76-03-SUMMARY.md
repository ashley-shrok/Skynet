...
The D-07 verification covered the scenario user described verbatim: "two spinning bubbles in flight during a widened wait, both deliver in order when wake completes, no bubbles lost or reordered, no dedup collision."
