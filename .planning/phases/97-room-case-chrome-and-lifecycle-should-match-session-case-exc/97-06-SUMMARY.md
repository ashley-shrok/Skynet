...
Per Plan 97-01 Resolution: "Live-browser verification: DEFERRED to phase-end deploy (standard fleet pattern — no deploy happens mid-phase; Task 1–3 commits are not live in user's environment)."

At phase-end deploy, the confirmatory reproduction user will run:
