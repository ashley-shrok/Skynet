...
**Source:** In-chat design lock with user 2026-08-13
...
**Out of scope:**
- Retiring `MicButton` or `RecordingControls` — both paths coexist. user 2026-08-13: "I'm cool with the threshold you mentioned … we keep both paths, you know this hold thing is just another way to interact."
...
<decisions>
## Implementation Decisions (locked with user 2026-08-13)
...
*Context gathered: 2026-08-13 via in-chat design lock with user*
