...
| --------------------- | ------ |
| Voice-in end-to-end (transcript-return correctness against user's real voice) | Handler code + adapter tests ship green; live-fleet UAT belongs to the phase-close ship gate |
