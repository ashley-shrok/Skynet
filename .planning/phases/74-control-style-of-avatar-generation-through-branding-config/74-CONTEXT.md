...
- The manual avatar-generation runbook was developed 2026-07-09 across ~6 hours with user. Locked in the fleet aesthetic (MOBA-champion / LoL-splash portraits) and the 0.7 gamma default.
...
- If the manual runbook file's deletion loses something that's still needed. user confirmed all its outrigger content is retired, but a scope-check during execution should re-verify nothing has quietly become live-again.
