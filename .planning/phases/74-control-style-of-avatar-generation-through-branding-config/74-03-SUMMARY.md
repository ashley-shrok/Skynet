...
- **NO ARCHETYPE_SYSTEM_PROMPT dead code** — grep returns 0. Constant deleted outright per 74-RESEARCH.md § Anti-Patterns to Avoid #1 and user `<additional_context>` load-bearing anti-pattern list.
