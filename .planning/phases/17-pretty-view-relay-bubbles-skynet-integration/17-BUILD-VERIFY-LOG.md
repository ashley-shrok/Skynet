...
**user (or Tina post-deploy): run these BEFORE starting the UAT walkthrough.**
...
**READY FOR USER GREENLIGHT**

Phase 17 code side is clean. All six RELAYBUB requirements are code-complete on
`feat/tab-title-from-tmux` at tip `53379ef`. Awaiting user's deploy + UAT walkthrough
