...
`git diff --stat src/ui/features/pretty-view/ChatMessage.tsx src/ui/features/pretty-view/ComposeBox.tsx src/ui/features/terminal/IdentityBadge.tsx` → zero lines changed. user's 2026-07-23 lock held.
