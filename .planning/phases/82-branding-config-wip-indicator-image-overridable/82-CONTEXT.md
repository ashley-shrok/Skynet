...
**Source:** In-session scope discussion with user (greenlit `thumbs up` 2026-09-07). Bounty `branding-config-wip-indicator-image-overridable` (pinned).
...
*Context gathered: 2026-09-07 (in-session with user — /build shape → GSD phase route)*
