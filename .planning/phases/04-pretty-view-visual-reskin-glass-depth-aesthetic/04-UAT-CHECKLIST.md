...
**Purpose**: post-deploy walk-through user runs to confirm the Phase 4 Glass depth reskin works end-to-end across VISUAL-01 through VISUAL-10.
...
**Failure indicator**: compose looks like a raised card with hard edges, bright top rim, or a bordered panel treatment. This was the Round-3 dead-end user explicitly rejected — treat any card treatment on compose as a regression.
...
- [ ] user signs off: **"Phase 4 UAT green — pin the deploy."**
