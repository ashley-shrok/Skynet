...
## Areas discussed (user: "all three, give me your recommendations")

### 1. Tooltip copy

**Options presented:**
- "Unshipped local work" (shape placeholder, terse)
- "Trapped local work — not yet shipped" (uses user's own "trapped" framing; potentially alarmist)
...
**Decision**: "**Has** local work not yet pushed to any remote" — user agreed, requested addition of "Has" to lead the sentence.
