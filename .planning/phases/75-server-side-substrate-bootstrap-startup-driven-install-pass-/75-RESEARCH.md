...
- D-13: Migration takes every existing substrate-host owner's key material as input (feasible because both live instances have small, known user populations and user has all the credentials).
...
### Secondary (CONTEXT.md decisions — locked by user)
