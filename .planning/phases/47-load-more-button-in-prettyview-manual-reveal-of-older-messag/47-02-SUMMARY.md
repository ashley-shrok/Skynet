...
**Rationale:** Same glyph `AttachmentChipStrip.tsx` L164 uses for its error affordance. Keeps the pretty-view error vocabulary consistent — user learns the glyph once and it means "this failed, and you can act on it".
