...
- **Visual byte-parity of harness case:** Automated tests (all 1061 pretty-view tests green) + slice-level "harness case byte-identical" assertions provide strong evidence. user's daily use is the ultimate confirmation. This is an ongoing regression floor, not a phase-93 acceptance blocker.
