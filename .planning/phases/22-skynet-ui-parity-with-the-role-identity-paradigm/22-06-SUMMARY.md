...
tech-stack:
  ...
  patterns:
    ...
    - "Shared TabState<string> import — RoleFileTab imports TabState from
      ...
      WakeupsTab."
    - "No no-role fallback branches (D-CONTEXT LOCK, user 2026-08-04): a
      ...
      response, surfaces as RoleFileTab's error render (Test 20). user sees
