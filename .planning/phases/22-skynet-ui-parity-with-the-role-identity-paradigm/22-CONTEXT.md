...
**NOT in this phase:** DB schema changes, delete role/identity, manage-roles list surface, legacy no-role identity handling (user confirmed no such identities exist post-migration), role display outside IdentityModal.
...
- `~/.claude/roles/box-maintainer/bounties/skynet-role-identity-crud-ui/design-and-waves.md` — Locked design + wave breakdown. Reviewed by user 2026-08-04.
