...
**Source:** UAT-locked architectural decisions from user 2026-08-18 (Phase 43 = patch #465 UAT-failed)
...
### Backend architecture (LOCKED — user 2026-08-18 UAT)
...
### Client architecture (LOCKED — user 2026-08-18 UAT)
...
**Consequences accepted (user UAT verbatim: "More bandwidth on cold load but zero observation-channel damage. This is the honest fix"):**
...
*Context authored: 2026-08-18 from user's UAT-locked decisions (verbatim quotes preserved in <decisions> and <domain>)*
