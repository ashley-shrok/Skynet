...
This is the expected single-user window — user's deploy motion is quick; a mid-deploy tab-open surfaces as a browser console 400, not data loss. Next remount post-Plan-04 wires the correct call signature.
