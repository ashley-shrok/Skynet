...
list replaced was host-organized and user's mental model was still "which
...
- The ready-dot was originally gated to "active-set only" and only visible
  when a row was in the small set user was actively working. That gate was
