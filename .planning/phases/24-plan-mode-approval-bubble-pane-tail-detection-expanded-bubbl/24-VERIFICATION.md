...
human_verification:
  ...
  - test: "user cannot accidentally approve via ComposeBox Enter during plan-pending"
...
**Phase Goal:** Make the Claude Code plan-approval prompt actionable from the pretty view. user can now approve plan-mode prompts from the browser, see the plan she's approving, and give feedback via modal — without accidentally approving via compose-box Enter.
