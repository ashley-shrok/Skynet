...
**Notes:** user explicitly framed this whole build as "not in a rush, do this thing right" — combined with R&D having been thorough enough that infra unknowns are gone, single deploy is fine. No feature-flag ceremony needed.
...
**Notes:** user verbatim: "full audit because we're gonna take our time and do this whole thing right. We are not in a rush." The cookie widen is a security posture change; half-audits are how you ship CSRF holes.
...
- **Custom visual affordance shape** for BOTH file URLs and serve URLs — user wants a tasting session; deferred out of Phase 103. Bounty `serve-and-file-url-visual-affordances` opens at end of session.
