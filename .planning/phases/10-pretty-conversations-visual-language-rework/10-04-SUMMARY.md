...
1. `docker compose build` + `docker compose up -d --force-recreate skynet` under whatever deploy discipline is active in the fork on 2026-07-22 (Alice noted the 15-min deadman regime was retired 2026-07-21; use whatever supersedes it).
2. Alice UAT of the new PrettyConversationsPanel across desktop + mobile viewports.
