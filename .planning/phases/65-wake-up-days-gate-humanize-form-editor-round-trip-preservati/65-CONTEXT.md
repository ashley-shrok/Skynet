...
Two symmetric bugs in the Skynet identity-modal wake-up card, discovered 2026-08-31 when user noticed that Aqua@Workstation's "weekdays at 23:00" schedule renders as **"Daily at 23:00"** in the identity modal. Root cause: the wake-up scheduler (`~/.claude/identities/*/wakeups/wakeup-scheduler.py` L117-122) accepts an optional `days: [...]` day-of-week gate alongside any schedule type, but two identity-modal surfaces don't know about it:
