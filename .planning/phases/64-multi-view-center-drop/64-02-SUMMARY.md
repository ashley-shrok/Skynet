...
tech_stack:
  ...
  patterns:
    ...
    - explicit-field logging (no JSON.stringify on inputs) per fleet directive user 2026-08-11
key_files:
  created:
...
Exit code 0 both runs. Green-gate satisfied per box-maintainer role (user
