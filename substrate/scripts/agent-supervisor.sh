...
drive() {
  ...
  # 2026-08-29 user report) + never-landed-paste + submission verification with a state-machine
...
pending_check() {
  local name="$1"
  # matrix_peek intentionally NOT called here (user 2026-09-12). A LIVE identity's receiver
