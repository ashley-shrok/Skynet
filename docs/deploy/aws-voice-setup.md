...
- Instance-specific notes for **t1000 (user)** and **T800 (Stacy)**.
...
If any step is unclear or fails, contact user (not tabitha directly —
user routes questions to the right person).
