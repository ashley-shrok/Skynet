// ─── WeeklyUsageMeter ─────────────────────────────────────────────────────────
// Single-bar fill+tick meter (user 2026-07-29 pick — B variant from the
...
// No numeric percentage text — bars alone communicate progress (user
 ...
 * Used for the bar hover tooltip so user can see exactly how much
...
function MeterRow({
  ...
  // Native title hover — pairs with the visual tick so user can read the
