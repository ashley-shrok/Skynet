...
// PrettyConversationRow. Renders ONLY when the row is in user's active-set
// AND non-RDP — row-level policy, this component is a dumb visual.
//
// quick-260727-gm3 (user 2026-07-27 preview lockdown): deactivate is the
...
// with a subtle red drop-shadow, per user's deactivate-preview.js console
// snippet.
//
