/**
 * Phase 90 Plan 06 Task 2 — AgentBadgeWithAppendage.
 *
 ...
 * reset-click callback prop. The parent (IdentityBadgeRow via
 * RelayRoomPane) does not need to know or plumb the reset action. Simpler
 * than the prior revision that deferred the endpoint.
 *
...
export interface AgentBadgeWithAppendageProps {
   ...
   * (RelayRoomPane / IdentityBadgeRow in Task 3) via
...
export function AgentBadgeWithAppendage({
  identityKey,
  mxid: _mxid,
  hostId,
  tmuxSessionName,
}: AgentBadgeWithAppendageProps) {
