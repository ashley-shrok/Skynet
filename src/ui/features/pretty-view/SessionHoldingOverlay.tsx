...
// pill. user's live 2026-07-19 design read: the old top-bar treatment
...
//     UNCOVERED so user can pre-draft the next message during the
  ...
  return (
    <div
      ...
      className={cn(
        ...
        // recycle — user wants to see who's speaking and open the
