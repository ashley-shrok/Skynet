 ...
 * recycle while leaving the textarea typeable so user can pre-draft
 ...
 * recycle lands in the textarea/slot but does NOT dispatch — user
...
describe("ComposeBox — quick 260729-j8l recycleActive gating", () => {
  ...
  it("B5: recycleActive=false (default) — baseline sanity, Send enabled and short-tap fires onSend", async () => {
