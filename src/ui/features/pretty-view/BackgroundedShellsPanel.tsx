...
// empty.
//
// Design decisions (locked with user 2026-07-18):
...
//     line. user called the second-line command-truncation visual
  ...
  return (
    <div
      className={cn(
        ...
        // (user 2026-07-19 flagged the floating-card + margin illusion
