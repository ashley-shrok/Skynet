...
// and asideText are all preserved verbatim (contrast with
...
// cause — user SSH-attaching and pressing Escape herself, tmux death,
 ...
 * parseable). Rendered as a compact placeholder bubble so user sees
