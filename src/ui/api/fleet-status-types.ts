...
export interface SessionState {
  ...
  // per user's lock. MUST stay in lockstep with the backend schema.
  ...
  //   - `activityMtime` bumps on `UserPromptSubmit` (user submitted a prompt)
  ...
  //     user for a permission decision — same as done from the affordance's
