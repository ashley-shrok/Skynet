 ...
 * currentContent cat, and post-write re-stat — user UAT of 70q ship caught
 ...
 *       UX user hit that replaced the textarea with "No content in this file yet"
 */
...
describe("PUT /global-files/write — tilde-expansion (user 2026-08-05 false-409 fix)", () => {
