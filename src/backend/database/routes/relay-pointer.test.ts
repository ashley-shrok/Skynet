 ...
 *
 * Coverage (13 tests):
 *   Test 1  : whitelist accept — identity-dir path shape accepted (user's reproducer path)
...
describe("GET /relay-pointer", () => {
  it("Test 1: whitelist accept — identity-dir path shape accepted (user's reproducer path)", () => {
    // user's exact reproducer path from recv.sh (fleet tree, Phase 96+) — MUST match
