...
export const users = sqliteTable("users", {
  ...
  // `_human` suffix per D-06). Legacy users (user/Zoey/Laura on t1000,
...
// Phase 85 (D-01, D-02): identity_send_log — records when user last sent a
...
// at the SQL layer — a row only exists after user's first send).
