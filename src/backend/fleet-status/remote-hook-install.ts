...
# affordance's one question: "should user look at this row?"
#
# Wired by Plan 62-02's installer to BOTH of these settings.json hooks:
#   - hooks.UserPromptSubmit[0].hooks[]  (user submitted a prompt)
...
#   - hooks.PermissionRequest[0].hooks[] (agent blocked waiting on user)
#
...
# is done" — both mean the row deserves user's attention right now. This
