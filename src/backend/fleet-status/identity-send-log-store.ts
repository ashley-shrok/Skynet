 ...
 * if the send later fails at the transport layer, user's INTENT to talk
...
/**
 * Record that user just sent a message from the compose surface to the
...
/**
 * Read the recorded unix-millis timestamp of user's last send to the
