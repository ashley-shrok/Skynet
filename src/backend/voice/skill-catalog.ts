 ...
 * know about the pure matcher from plan 01, and is not aware of user's
 ...
 *
 * FAIL-OPEN CONTRACT (design decision — user 2026-08-13, verbatim from
 ...
 *
 * Rationale (user 2026-08-13, verbatim): "increase the timeout to something
