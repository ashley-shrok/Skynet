...
function normalizeBounty(parsed: Record<string, unknown>, fallbackId: string): unknown {
  return {
    ...
    // field is a UUID — useless for humans. The FOLDER name is what user
...
// scope (the id skill handles archive population on its own cadence; user
...
// Semantics locked by user (see PLAN.md § Semantics):
//
