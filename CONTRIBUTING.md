...
1. Clone the repository:
   ```sh
   git clone https://github.com/Skynet-SSH/Skynet
   ```
...
This will start the backend and the frontend Vite server. You can access Skynet by going to `http://localhost:5174/`.

## Contributing

1. **Fork the repository**: Click the "Fork" button at the top right of
   the [repository page](https://github.com/Skynet-SSH/Skynet).
...
If you need help or want to request a feature with Skynet, visit the [Issues](https://github.com/Skynet-SSH/Support/issues) page, log in, and press `New Issue`.
